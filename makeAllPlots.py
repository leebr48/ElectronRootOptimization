...
print('The plots for figure 5 were made elsewhere.')
print('Skipping figure 5.')

print('The plots for figure 6 were made elsewhere.')
print('Skipping figure 6.')

print('Making plots for figure 7.')
os.chdir(os.path.join(thisDir, 'figure7'))
os.system('python plot_densityAndTemperatureProfs.py')
os.system('python plot_otherProfs.py')
print('Finished making plots for figure 7.')
